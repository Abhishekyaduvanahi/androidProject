...
public class Adapter extends RecyclerView.Adapter<Adapter.ViewHolder>{
    ...
    @NonNull
      ...
      holder.mtime.setText("Published at :-" +modalclassesArraylist.get(position).getPublishedAt());
            ...
            holder.mauthor.setText("Published at :-" +modalclassesArraylist.get(position).getAuthor());
            holder.mheading.setText("Published at :-" +modalclassesArraylist.get(position).getTitle());

            holder.mcontent.setText("Published at :-" +modalclassesArraylist.get(position).getDescription());
